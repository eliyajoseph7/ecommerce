        ...
        <div class="pl-16 py-4">
            ...
            <form>
                <div class="grid gap-6 mb-6 md:grid-cols-2">
                    <div>
                        <label for="region_id" class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">Region
                            <span class="text-red-500">*</span></label>
                        <select wire:model.live="region_id"
                            class="bg-gray-50 border border-gray-300 text-gray-700 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark-remove:bg-gray-700 dark-remove:border-gray-600 dark-remove:placeholder-gray-400 dark-remove:text-white dark-remove:focus:ring-blue-500 dark-remove:focus:border-blue-500">
                    ...
                    <div>
                        <label for="district_id"
                            class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">District <span
                    ...
                    <div>
                        <label for="ward_id" class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">Ward
                            <span class="text-red-500">*</span></label>
                    ...
                    <div class="">
                        <label for="village_id"
                            class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">Village/Street <span
                                class="text-red-500">*</span></label>
                    ...
                    <div class="col-span-full">
                        <label for="company"
                            class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">Address <span
                                class="text-red-500">*</span></label>
                ...
                <div class="{{ $showBillAddress ? 'grid' : 'hidden' }} gap-6 mb-6 md:grid-cols-3">
                    <div>
                        <label for="billing_first_name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">First Name <span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="billing_last_name"
                            class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">Last Name <span
                                class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="billing.region_id"
                            class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">Region
                            <span class="text-red-500">*</span></label>
                    ...
                    <div>
                        <label for="billing.ward_id"
                            class="block mb-2 text-sm font-medium text-gray-900 dark-remove:text-white">Ward
                            <span class="text-red-500">*</span></label>
