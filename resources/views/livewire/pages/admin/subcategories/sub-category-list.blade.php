<div>
    <x-slot name="header">
        @include('includes.breadcrumb', [
            'main' => '',
            'menu' => 'Sub-categories Management',
        ])
    </x-slot>
    <div>
        <div class="py-0">
            <div class="max-w-full mx-auto sm:px-6 lg:px-0">
                <div class="w-full pt-3">
                    <div class="flex justify-end pb-2">
                        <a href="{{ route('sub_category_form') }}"
                            ...
                            <span class="">{{ __('Add Sub-Category') }}</span>
                        </a>
                                                ...
                                                @foreach ($values as $dt)
                                                    <tr wire:key="{{ $dt->id }}"
                                                        ...
                                                        <td
                                                            ...
                                                            <a title="Update"
                                                                href="{{ route('sub_category_form_edit', $dt->id) }}"
            ...
            Livewire.on('confirm_delete', (id) => {
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        Livewire.dispatch('delete_sub_category', {
                            'id': id
                        });
                    }
                });
